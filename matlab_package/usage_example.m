...
s       = s(:);
b_true  = 1;
y       = (s .* X) * b_true + reshape(randn(N, 1).*randn(1, T), [N*T, 1]) + randn(N*T, 1);
...
model.small_sample = false;              % Imbens-Kolesar-2016-REStat small sample refinement; defaults to false
